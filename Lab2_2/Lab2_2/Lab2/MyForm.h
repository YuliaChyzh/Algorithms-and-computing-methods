...
private: System::Void Click_Sorting(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 for (int i = 250; i <= 35000; i += 250) {
				 ...
				 SortMass(mas, i);			// підпрограма сортування
				 ...
				 textBox2->AppendText(Convert::ToString((double)calc_time/1000) + " с" + Environment::NewLine);	// добавити в textBox2 час сортування
			 }
